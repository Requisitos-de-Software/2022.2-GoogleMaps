...
| Código |  Critério  | Atende  | Erros encontrados |
| :----: | :--------: |:--------------------------------: |-----------------: |
| 1 | O histórico de versão padronizado? |  Parcialmente | No histórico da aba de [entrevisa](https://requisitos-de-software.github.io/2022.2-StarPlus/#/docs/Elicitacao/Tecnicas/Entrevista) é o único que não tem a ligação dos nomes dos integrantes com o github, em todos os outros estão padronizados |
| 2 | O(s) autor(es) e o(s) revisor(es) para cada artefato? |  Sim | --------- |
| 3 | Vídeo de apresentação na categoria “não listado” no youtube; |  Sim | --------- |
| 4 | Referências bibliográficas e/ou bibliografia em todos os artefatos | Sim | --------- |
| 5 | As tabelas e imagens possuem legenda e fonte e elas chamadas dentro dos texto? |  Parcialmente | Algumas tabelas em vários artefatos não possuem fonte, e não são chamadas dentro de textos |
| 6 | Um texto fazendo uma introdução dos artefatos? |  Parcialmente | No artefato [Resultado da elicitação](https://requisitos-de-software.github.io/2022.2-StarPlus/#/docs/Elicitacao/Resultado) não possui introdução |
...
| 15 | O Elenco de Personas? Quantas Personas no Projeto? O porquê dessa quantidade? |  Sim | --------- |
| 16 | Um cronograma (data e horário) e local para realização da elicitação dos requisitos com o do cliente e/ou persona do projeto? |  Parcialmete | No artefato da entrevista não tem documentado a data de realização da mesma |
| 17 | No mínimo três técnicas de elicitação foram utilizadas (quanto mais melhor)?  |  Sim  | --------- |
...
| 20 | Um cronograma (data e horário) e local para realização da priorização dos requisitos com o do cliente e/ou persona do projeto? |  Parcialmente | --------- |
...
| 07/01/2023 |  1.1  | Inserção dos resultados | Luíza     |      Alexia      |
