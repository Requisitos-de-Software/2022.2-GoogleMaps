...
|   4    |         Os contextos foram bem definidos?          |  13   | 13  |  0  |        0.00%        |      ---      |           ---            |
...
|   5    | É apresentado a especificação do diagrama de caso de uso (com Nome, Descrição, Atores, Pré e Pós-Condição, Fluxo Principal, Alternativo e de Exceção etc.) |  13   | 13  |  0  |        0.00%        |               |                          |
