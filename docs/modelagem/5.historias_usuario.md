...
| Critérios de Aceitação | 1. Deve ser possível inserir comentários na seção de avaliação dos estabelecimentos. </br> 2. Deve ser possível comentar outros comentários. |
...
| Critérios de Aceitação | 1. Deve ser possível ver a faixa de preço dos produtos ou serviços de um estabelecimento pela quantidade sua de cifrões. </br> 2. A quantidade de cifrões deve se basear em outros estabelecimentos do mesmo ramo da região. |
...
| 30/12/2022 | 2.0    | Adição de critérios de aceitação das US 1 a 16 e 34 a 38  | Marcus    |             |
