...
&emsp;&emsp; O requisito tratado como o de 12° maior prioridade foi o requisito de "DDeve ser possível ligar para a localização pesquisada caso disponível". Classificamos este requisito na elicitação como RF12, na tabela 12, abaixo veremos um possível cenário para este requisito.
