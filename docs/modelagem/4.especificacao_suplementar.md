...
| Descrição                                                                                                                             | Tipo |
| :------------------------------------------------------------------------------------------------------------------------------------ | :--: |
| O usuário é capaz de realizar ações mais complicadas em no máximo 5 clicks                                                            | ES01 |
| Um usuário experiente deve conseguir facilmente traçar rotas no aplicativo em uma semana de uso                                       | ES02 |
| Um usuário não experiente deve conseguir facilmente realizar todas as ações principais do aplicativo em uma semana de uso             | ES03 |
