...
&emsp;&emsp; O 11° léxico, se refere a "pesquisa de localidades no mapa". Suas características serão melhor detalhadas na tabela 11 abaixo.
...
&emsp;&emsp; O 14° léxico, se refere a "Navegar no modo *street view* do mapa". Suas características serão melhor detalhadas na tabela 14 abaixo.
...
&emsp;&emsp; O 15° léxico, se refere a "visualização do mapa". Suas características serão melhor detalhadas na tabela 15 abaixo.

<figcaption align="center">Tabela 15: Visualizar.</figcaption>

| Léxico     | Noção                                                     | Impacto                                                                                                                                                 | Sinônimo        | Classificação |
| ---------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------- |
| Visualizar | O usuário visualiza o mapa após seu acesso ao aplicativo. | O usuário pode escolher a escala de zoom que se deseja ver o mapa</br> O usuário pode visualizar diferentes localidades sem necessariamente estar nelas | Ver, observar | Verbo         |

<figcaption align="center">Fonte: Lucas Felipe </figcaption>

### 3.16 Visualizar avaliações

&emsp;&emsp; O 16° léxico, se refere a "visualizar a avaliação de locais". Suas características serão melhor detalhadas na tabela 16 abaixo.
